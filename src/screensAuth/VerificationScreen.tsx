                ...
                <View className='flex-1 bg-gray-500'>
                    ...
                    <View className='flex-1 bg-white px-8 pt-8 mt-10' style={{ borderTopLeftRadius: 50, borderTopRightRadius: 50 }}>
                        <View className='form space-y-2'>
                            ...
                            <TouchableOpacity className='py-3 bg-blue-400 rounded-xl mb-4' onPress={submitOTP}>
                                <Text className='font-bold text-center text-gray-700'>Verificar</Text>
                            </TouchableOpacity>

                            <TouchableOpacity className='py-3 bg-cyan-400 rounded-xl mt-4' onPress={resendCode}>
